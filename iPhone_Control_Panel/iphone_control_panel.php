...
echo '/wp-content/plugins/iPhone_Control_Panel/css/iphone_css.php';
...
echo '" type="text/css" rel="stylesheet" />
	...
	echo get_bloginfo('wpurl');
	echo '/wp-content/plugins/iPhone_Control_Panel/icons/';
...
<p>(The icons used in this plugin come from <a href="http://www.everaldo.com/crystal/" title="Crystal">Crystal</a>, a great open source collection of icons.)</p>
  ...
  <tr>
    <td colspan="3"><img src="<?php	echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/images/iphone_top.jpg" width="453" height="423" /></td>
  </tr>
  <tr>
    <td width="240"><img src="<?php	echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/images/iphone_left.jpg" width="240" height="57" /></td>
    <td width="57" height="57" background="<?php echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/icons/<?php 
	global $options_icp;
	foreach ($options_icp as $value) {
	    if (get_settings( $value['id'] ) === FALSE) { $$value['id'] = $value['std']; } 
	      else { $$value['id'] = get_settings( $value['id'] ); } 
	}
echo $iphone_control_panel_icon; ?>"><img src="<?php	echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/images/button_overlay.png" width="57" height="57" /></td>
    <td width="156"><img src="<?php	echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/images/iphone_right.jpg" width="156" height="57" /></td>
  </tr>
  <tr>
    <td colspan="3"><img src="<?php	echo get_bloginfo('wpurl'); ?>/wp-content/plugins/iPhone_Control_Panel/images/iphone_bottom.jpg" width="453" height="334" /></td>
  </tr>
</table>
</td>
    </tr>
